...
final class w_78 extends Strategy {
							...
							if (cons1 == desugar._consFunDef_3) {
								Fail74: {
									...
									if (term == null)
										break Fail74;
									a_78 = term;
									term = v_78.instance.invoke(context, a_78,
											this);
									if (term == null)
										break Fail74;
									term = termFactory.makeAppl(
											desugar._consFunDefDesug_3,
											new IStrategoTerm[] { x_77, term,
													z_77 });
									if (true)
										break Success16;
								}
								...
								if (cons1 == desugar._consFunCall_2) {
									Fail75: {
										...
										if (term == null)
											break Fail75;
										g_78 = term;
										term = v_78.instance.invoke(context,
												g_78, this);
										if (term == null)
											break Fail75;
										term = termFactory.makeAppl(
												desugar._consFunCallDesug_2,
												new IStrategoTerm[] { e_78,
														term });
								...
								Success18: {
									if (cons1 == desugar._consIfNoElse_2) {
										Fail76: {
											...
											term = termFactory
													.makeAppl(
															desugar._consIfThenElse_3,
															new IStrategoTerm[] {
																	k_78,
																	l_78,
																	desugar.constEmptyBlock0 });
											if (true)
												break Success18;
										}
										term = term2;
