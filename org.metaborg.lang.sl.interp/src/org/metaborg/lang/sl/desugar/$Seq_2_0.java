...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, Strategy j_6, Strategy k_6)
  { 
    ...
    { 
      ...
      if(term == null)
        break Fail45;
      term = termFactory.annotateTerm(termFactory.makeAppl(desugar._consSeq_2, new IStrategoTerm[]{s_73, term}), checkListAnnos(termFactory, r_73));
