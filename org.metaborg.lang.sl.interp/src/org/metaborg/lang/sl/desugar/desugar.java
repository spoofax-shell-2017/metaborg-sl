...
public class desugar {
	...
	protected static IStrategoTerm constStmt0;
	...
	public static void initConstructors(ITermFactory termFactory) {
		...
		_consSLDefineFunction_1 = termFactory.makeConstructor(
				"SLDefineFunction", 1);
		_consMethodCallDesug_3 = termFactory.makeConstructor("MethodCallDesug",
				3);
	...
	public static void initConstants(ITermFactory termFactory) {
		...
		constNoArgSeq0 = termFactory
				.makeAppl(desugar._consNoArgSeq_0, NO_TERMS);
		constFunCallDesug0 = termFactory.makeAppl(desugar._consFunCallDesug_2,
				new IStrategoTerm[] { desugar.const2, desugar.constNoArgSeq0 });
		constEmptyBlock0 = termFactory.makeAppl(desugar._consEmptyBlock_0,
				NO_TERMS);
		constSLNanoTime0 = termFactory.makeAppl(desugar._consSLNanoTime_0,
				NO_TERMS);
		constSLNewObject0 = termFactory.makeAppl(desugar._consSLNewObject_0,
				NO_TERMS);
		constSLReadln0 = termFactory
				.makeAppl(desugar._consSLReadln_0, NO_TERMS);
		constSLStacktrace0 = termFactory.makeAppl(desugar._consSLStacktrace_0,
				NO_TERMS);
		constStmt0 = termFactory.makeAppl(desugar._consStmt_1,
				new IStrategoTerm[] { desugar.constFunCallDesug0 });
		constNoFunDefSeq0 = termFactory.makeAppl(desugar._consNoFunDefSeq_0,
				NO_TERMS);
		constNoParamSeq0 = termFactory.makeAppl(desugar._consNoParamSeq_0,
				NO_TERMS);
	}

	public static void registerInterop(
			org.spoofax.interpreter.core.IContext context,
			Context compiledContext) {
		new InteropRegisterer().registerLazy(context, compiledContext,
				InteropRegisterer.class.getClassLoader());
	}
}