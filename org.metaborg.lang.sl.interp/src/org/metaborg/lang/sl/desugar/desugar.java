...
{ 
  ...
  { 
    ...
    constFunCallDesug0 = termFactory.makeAppl(desugar._consFunCallDesug_2, new IStrategoTerm[]{desugar.const0, desugar.constNoArgSeq0});
    ...
    constStmt0 = termFactory.makeAppl(desugar._consStmt_1, new IStrategoTerm[]{desugar.constFunCallDesug0});
