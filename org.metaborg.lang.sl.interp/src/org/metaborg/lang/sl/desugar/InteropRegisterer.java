...
{ 
  ...
  { 
    ...
    varScope.addSVar("desugar_funcs_0_0", new InteropSDefT(desugar_funcs_0_0.instance, context));
    varScope.addSVar("desugar_params_0_0", new InteropSDefT(desugar_params_0_0.instance, context));
    varScope.addSVar("desugar_args_0_0", new InteropSDefT(desugar_args_0_0.instance, context));
    ...
    varScope.addSVar("EmptyBlock_0_0", new InteropSDefT($Empty$Block_0_0.instance, context));
    ...
    varScope.addSVar("FunDefSeq_2_0", new InteropSDefT($Fun$Def$Seq_2_0.instance, context));
    varScope.addSVar("NoFunDefSeq_0_0", new InteropSDefT($No$Fun$Def$Seq_0_0.instance, context));
    varScope.addSVar("FunDefDesug_3_0", new InteropSDefT($Fun$Def$Desug_3_0.instance, context));
    varScope.addSVar("ParamSeq_2_0", new InteropSDefT($Param$Seq_2_0.instance, context));
    varScope.addSVar("NoParamSeq_0_0", new InteropSDefT($No$Param$Seq_0_0.instance, context));
    varScope.addSVar("FunCallDesug_2_0", new InteropSDefT($Fun$Call$Desug_2_0.instance, context));
    varScope.addSVar("ArgSeq_2_0", new InteropSDefT($Arg$Seq_2_0.instance, context));
    varScope.addSVar("NoArgSeq_0_0", new InteropSDefT($No$Arg$Seq_0_0.instance, context));
    varScope.addSVar("MethodCallDesug_3_0", new InteropSDefT($Method$Call$Desug_3_0.instance, context));
  ...
  { 
    ...
    varScope.addSVar("desugar_funcs_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.desugar_funcs_0_0", context));
    varScope.addSVar("desugar_params_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.desugar_params_0_0", context));
    varScope.addSVar("desugar_args_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.desugar_args_0_0", context));
    ...
    varScope.addSVar("Seq_2_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Seq_2_0", context));
    varScope.addSVar("EmptyBlock_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Empty$Block_0_0", context));
    ...
    varScope.addSVar("FunDefSeq_2_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Fun$Def$Seq_2_0", context));
    varScope.addSVar("NoFunDefSeq_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$No$Fun$Def$Seq_0_0", context));
    varScope.addSVar("FunDefDesug_3_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Fun$Def$Desug_3_0", context));
    varScope.addSVar("ParamSeq_2_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Param$Seq_2_0", context));
    varScope.addSVar("NoParamSeq_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$No$Param$Seq_0_0", context));
    varScope.addSVar("FunCallDesug_2_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Fun$Call$Desug_2_0", context));
    varScope.addSVar("ArgSeq_2_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Arg$Seq_2_0", context));
    varScope.addSVar("NoArgSeq_0_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$No$Arg$Seq_0_0", context));
    varScope.addSVar("MethodCallDesug_3_0", new InteropSDefT(classLoader, "org.metaborg.lang.sl.desugar.$Method$Call$Desug_3_0", context));
