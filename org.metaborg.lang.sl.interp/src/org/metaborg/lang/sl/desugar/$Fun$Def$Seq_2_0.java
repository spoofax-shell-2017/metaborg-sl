...
{ 
  ...
  @Override public IStrategoTerm invoke(Context context, IStrategoTerm term, Strategy w_6, Strategy x_6)
  { 
    ...
    { 
      ...
      if(term == null)
        break Fail56;
      term = termFactory.annotateTerm(termFactory.makeAppl(desugar._consFunDefSeq_2, new IStrategoTerm[]{z_74, term}), checkListAnnos(termFactory, y_74));
