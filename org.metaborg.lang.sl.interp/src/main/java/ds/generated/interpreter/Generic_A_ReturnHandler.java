...
public class Generic_A_ReturnHandler extends A_ReturnHandler implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_ReturnHandler (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_ReturnHandler specialize()
  { 
