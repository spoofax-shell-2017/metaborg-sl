...
public class SLReadln_0 extends A_Expr 
{ 
  public SLReadln_0 (SourceSection src) 
  { 
    super(src);
  }
  ...
  { 
    ...
    final SLReadln_0 other = (SLReadln_0)obj;
    return true;
  }
  ...
  { 
    IStrategoAppl term = factory.makeAppl(factory.makeConstructor("SLReadln", 0));
    return term;
  }
}