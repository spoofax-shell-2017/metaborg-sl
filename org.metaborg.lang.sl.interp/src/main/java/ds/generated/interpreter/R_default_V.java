...
{ 
  ...
  public R_default_V (A_V value, com.github.krukow.clj_ds.PersistentMap<String, A_V> _1) 
  { 
    this.value = value;
    this._1 = _1;
  }
  ...
  { 
    return factory.makeAppl(factory.makeConstructor("R_default_V", 2), value.toStrategoTerm(factory), AutoMapUtils.map_String_A_V2aterm(_1, factory));
  }
