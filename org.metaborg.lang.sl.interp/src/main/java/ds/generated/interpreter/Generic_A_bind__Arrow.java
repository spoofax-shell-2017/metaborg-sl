...
public class Generic_A_bind__Arrow extends A_bind__Arrow implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_bind__Arrow (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_bind__Arrow specialize()
  { 
