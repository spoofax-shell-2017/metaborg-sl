...
public class Generic_A_invoke__Arrow extends A_invoke__Arrow implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_invoke__Arrow (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_invoke__Arrow specialize()
  { 
