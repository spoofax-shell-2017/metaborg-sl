...
public class Generic_A_write__Arrow extends A_write__Arrow implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_write__Arrow (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_write__Arrow specialize()
  { 
