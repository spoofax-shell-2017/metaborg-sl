...
public class False_0 extends A_Expr 
{ 
  public False_0 (SourceSection src) 
  { 
    super(src);
  }
  ...
  { 
    final A_C c_13417 = _1;
    final com.github.krukow.clj_ds.PersistentMap<String, A_V> l_string_v_13301 = _2;
    final BoolV_1 lifted_864600 = new BoolV_1(this.getSourceSection(), false);
    return new R_default_V(lifted_864600, l_string_v_13301);
  }
