...
public class Generic_A_lookup__Arrow extends A_lookup__Arrow implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_lookup__Arrow (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_lookup__Arrow specialize()
  { 
