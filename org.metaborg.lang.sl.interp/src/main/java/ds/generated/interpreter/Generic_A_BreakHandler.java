...
public class Generic_A_BreakHandler extends A_BreakHandler implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_BreakHandler (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_BreakHandler specialize()
  { 
