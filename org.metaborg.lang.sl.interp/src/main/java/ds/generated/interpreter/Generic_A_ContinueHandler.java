...
public class Generic_A_ContinueHandler extends A_ContinueHandler implements IGenericNode
{ 
  private IStrategoTerm aterm;

  public Generic_A_ContinueHandler (SourceSection src, IStrategoTerm term) 
  { 
    super(src);
  ...
  @Override public A_ContinueHandler specialize()
  { 
