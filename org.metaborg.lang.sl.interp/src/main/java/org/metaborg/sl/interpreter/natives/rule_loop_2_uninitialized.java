...
import org.metaborg.sl.interpreter.generated.terms.U_0_Term;
import org.metaborg.sl.interpreter.generated.terms.expandBoolV_1_Term;
...
public class rule_loop_2_uninitialized extends Rule {
	...
	public rule_loop_2_uninitialized() {
		super(SourceSection.createUnavailable("Rule", "loop"),
				new FrameDescriptor(),
				RuleRegistry.makeKey("default", "loop", 2));
	}
	...
	public RuleResult execute(VirtualFrame frame) {
		...
		return replace(new rule_loop_2_initialized(condInvocationNode,
	...
	private class rule_loop_2_initialized extends rule_loop_2_uninitialized {
		...
		public RuleResult execute(VirtualFrame frame) {
			...
			return new RuleResult(U_0_Term.SINGLETON,
