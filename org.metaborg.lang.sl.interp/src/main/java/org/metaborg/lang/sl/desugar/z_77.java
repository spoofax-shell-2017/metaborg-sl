...
@SuppressWarnings("all") final class z_77 extends Strategy 
{ 
  public static final z_77 instance = new z_77();
          ...
          { 
            ...
            { 
              ...
              { 
                ...
                x_76 = term.getSubterm(0);
                term = this.invoke(context, desugar.constFunCallDesug0);
                if(term == null)
                  break Fail69;
                term = termFactory.makeAppl(desugar._consProgramDesug_2, new IStrategoTerm[]{x_76, term});
                if(true)
                  break Success14;
              }
              term = term2;
            ...
            { 
              ...
              { 
                ...
                { 
                  ...
                  b_77 = term.getSubterm(1);
                  c_77 = term.getSubterm(2);
                  term = desugar_params_0_0.instance.invoke(context, b_77);
                  if(term == null)
                    break Fail70;
                  d_77 = term;
                  term = y_77.instance.invoke(context, d_77, this);
                  if(term == null)
                    break Fail70;
                  term = termFactory.makeAppl(desugar._consFunDefDesug_3, new IStrategoTerm[]{a_77, term, c_77});
                  if(true)
                    break Success15;
                }
                term = term2;
              ...
              { 
                ...
                { 
                  ...
                  { 
                    ...
                    i_77 = term.getSubterm(1);
                    term = desugar_args_0_0.instance.invoke(context, i_77);
                    if(term == null)
                      break Fail71;
                    j_77 = term;
                    term = y_77.instance.invoke(context, j_77, this);
                    if(term == null)
                      break Fail71;
                    term = termFactory.makeAppl(desugar._consFunCallDesug_2, new IStrategoTerm[]{h_77, term});
                ...
                { 
                  ...
                  { 
                    ...
                    { 
                      ...
                      n_77 = term.getSubterm(0);
                      o_77 = term.getSubterm(1);
                      term = termFactory.makeAppl(desugar._consIfThenElse_3, new IStrategoTerm[]{n_77, o_77, desugar.constBlock0});
                      if(true)
                        break Success17;
                    }
                    term = term2;
                  ...
                  { 
                    ...
                    { 
                      ...
                      { 
                        ...
                        p_77 = term.getSubterm(0);
                        q_77 = term.getSubterm(1);
                        r_77 = term.getSubterm(2);
                        term = desugar_args_0_0.instance.invoke(context, r_77);
                        if(term == null)
                          break Fail73;
                        s_77 = term;
                        term = y_77.instance.invoke(context, s_77, this);
                        if(term == null)
                          break Fail73;
                        term = termFactory.makeAppl(desugar._consMethodCallDesug_3, new IStrategoTerm[]{p_77, q_77, term});
                        if(true)
                          break Success18;
                      }
                      term = term2;
                      ...
                      { 
                        ...
                        { 
                          ...
                          if(arg2.getTermType() != IStrategoTerm.APPL || desugar._consNoArgSeq_0 != ((IStrategoAppl)arg2).getConstructor())
                            break Fail74;
                          term = termFactory.makeAppl(desugar._consSLDefineFunction_1, new IStrategoTerm[]{w_77});
                          if(true)
                            break Success19;
                        }
                        term = term2;
                            ...
                            { 
                              ...
                              { 
                                ...
                                if(arg9.getTermType() != IStrategoTerm.APPL || desugar._consNoArgSeq_0 != ((IStrategoAppl)arg9).getConstructor())
                                  break Fail77;
                                term = termFactory.makeAppl(desugar._consSLPrintln_1, new IStrategoTerm[]{x_77});
                                if(true)
                                  break Success22;
                              }
                              term = term2;
