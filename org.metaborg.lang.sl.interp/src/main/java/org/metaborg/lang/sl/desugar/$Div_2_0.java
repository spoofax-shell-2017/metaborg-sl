...
{ 
  ...
  { 
    ...
    { 
      ...
      d_70 = annos5;
      term = y_4.invoke(context, b_70);
      if(term == null)
        break Fail27;
      e_70 = term;
      term = z_4.invoke(context, c_70);
      if(term == null)
        break Fail27;
      term = termFactory.annotateTerm(termFactory.makeAppl(desugar._consDiv_2, new IStrategoTerm[]{e_70, term}), checkListAnnos(termFactory, d_70));
