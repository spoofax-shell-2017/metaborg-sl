 ...
 */
public class DynSemEvaluationStrategy {
    private final ClassPathInterpreterLoader interpLoader;
     ...
     */
    @Inject
    public DynSemEvaluationStrategy(ClassPathInterpreterLoader interpLoader,
    ...
    public IStrategoTerm evaluate(IStrategoTerm input, ILanguageImpl langImpl) throws MetaborgException {
    ...
    private void initializeExecutionEnvironment() throws MetaborgException {
        ...
        try {
            ...
            throw new RuntimeException("No shell initialization rule found.\n"
