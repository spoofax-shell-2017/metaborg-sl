...
public class SLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("SL");
  ...
  { 
    SLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = SLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = SLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(SLParseControllerGenerated.class);
    }
  ...
  { 
    return SLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
